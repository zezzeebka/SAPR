...
private:
    ...
    std::shared_ptr<Button> B1 = std::make_shared<Button>(200, 70, 300, 100, "data/graphs.png");
    std::shared_ptr<Button> B2 = std::make_shared<Button>(200, 70, 300, 250, "data/tables.png");
    std::shared_ptr<Button> B3 = std::make_shared<Button>(200, 70, 300, 400, "data/Result.png");
